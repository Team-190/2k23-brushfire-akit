...
public class RobotContainer {
  ...
  private final MechanismLigament2d bottomPivotLigament = mechanismRoot.append(
      new MechanismLigament2d("BottomPivot", 1.2, 90, 4, new Color8Bit(Color.kLightGreen)));
  private final MechanismLigament2d topPivotLigament = bottomPivotLigament.append(
